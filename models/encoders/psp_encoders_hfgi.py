...
class ResidualEncoder(Module):
    ...
    def forward(self, x):
        ...
        # print('final conditons size: ', conditions[0].size(), conditions[1].size())
        return conditions
...
#         aligned_conditions = []
#         shift = self.condition_shift(res[0])
#         scale = self.condition_scale(res[1])
#         aligned_conditions.append(shift)
#         aligned_conditions.append(scale)
